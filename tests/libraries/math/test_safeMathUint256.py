...
def testerSnapshot(sessionFixture):
    sessionFixture.uploadAndAddToController('solidity_test_helpers/SafeMathUint256Tester.sol')
...
def test_mul(a, b, expectedResult, testerContractsFixture):
    ...
    SafeMathInt256Tester = testerContractsFixture.contracts['SafeMathUint256Tester']
