...
contract OrdersFetcher is Controlled, IOrdersFetcher {
    ...
    function getOrder(bytes32 _orderId) public constant returns (uint256 _attoshares, int256 _displayPrice, address _owner, uint256 _sharesEscrowed, uint256 _tokensEscrowed, bytes32 _betterOrderId, bytes32 _worseOrderId, uint256 _gasPrice) {
        ...
        _owner = _orders.getOrderOwner(_orderId);
    ...
    function ascendOrderList(Trading.TradeTypes _type, int256 _fxpPrice, bytes32 _lowestOrderId) public constant returns (bytes32 _betterOrderId, bytes32 _worseOrderId) {
    ...
    function descendOrderList(Trading.TradeTypes _type, int256 _fxpPrice, bytes32 _highestOrderId) public constant returns (bytes32 _betterOrderId, bytes32 _worseOrderId) {
    ...
    function findBoundingOrders(Trading.TradeTypes _type, int256 _fxpPrice, bytes32 _bestOrderId, bytes32 _worstOrderId, bytes32 _betterOrderId, bytes32 _worseOrderId) public constant returns (bytes32, bytes32) {
        IOrders _orders = IOrders(controller.lookup("Orders"));
